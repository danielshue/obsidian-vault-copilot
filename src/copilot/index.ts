 ...
 * 
 * ```typescript
 * import { AIProvider } from "./copilot/providers";
 * import { McpManager } from "./copilot/mcp";
 * import { TOOL_NAMES, VaultOperations } from "./copilot/tools";
 * import { CustomizationLoader } from "./copilot/customization";
 * import { MainVaultAssistant } from "./copilot/realtime-agent";
