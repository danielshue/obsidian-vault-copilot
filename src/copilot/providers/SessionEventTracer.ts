...
export class SessionEventTracer {
	...
	handleEvent(event: SessionEvent): void {
		...
		let source: string = LOG_SOURCES.SDK_EVENT;
		let message = "";
		...
		switch (eventType) {
			...
			case "session.start": {
				level = "info";
				source = LOG_SOURCES.SESSION_LIFECYCLE;
			...
			case "session.model_change": {
				level = "info";
				source = LOG_SOURCES.SESSION_STATE;
			...
			case "assistant.turn_start": {
				level = "debug";
				source = LOG_SOURCES.ASSISTANT_EVENT;
			...
			case "system.message": {
				level = "info";
				source = LOG_SOURCES.SYSTEM_EVENT;
