import { App, Modal, PluginSettingTab, Setting, Notice, FileSystemAdapter, moment, Platform } from "obsidian";
...
import { isMobile, isProviderAvailable, getAvailableProviders } from "./utils/platform";
