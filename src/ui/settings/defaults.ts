...
/** Default plugin settings for Basic */
export const DEFAULT_SETTINGS: CopilotPluginSettings = {
	...
	cliUrl: "",
	streaming: true,
	requestTimeout: 2700000, // 45 minutes (2700 seconds)
	...
	automationDirectories: ["automations"],
